...
// This currently does not have a serialize file.
// Copyright (c) 2013 Perform3-D LLC

#ifndef APPQUEUECIRC_H
#define APPQUEUECIRC_H
...
public:
    ...
    explicit AppQueueCirc(size_type capacity) : m_lost_count(0), m_container(capacity) {}
...
private:
    AppQueueCirc(const AppQueueCirc&);              // Disabled copy constructor
    AppQueueCirc& operator = (const AppQueueCirc&); // Disabled assign operator
...
typedef AppQueueCirc<Geom3d> G3d_cq_t;
